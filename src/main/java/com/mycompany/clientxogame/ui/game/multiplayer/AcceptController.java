...
public class AcceptController implements Initializable {
            ...
            if (type.equals("invite_status_back")) {
                ...
                Platform.runLater(() -> {
                    if ("accept".equals(status)) {
                        NavigationManager.mySymbol = "X";
                        NavigationManager.isMyTurn = true;
                        NavigationManager.currentOpponent = NavigationManager.invitedFrom;
                        SoundManager.getInstance().playButton("enter");

                        NavigationManager.goToPlay(null);
                    } else {
    ...
    private void onActionCancel(ActionEvent event) {
        ...
        response.put("to", NavigationManager.invitedFrom);
